          ...
          <div className="flex items-center justify-between">
            ...
            <Link to="/" className="flex items-center space-x-3 group">
              ...
              <div className="hidden sm:block">
                ...
                <p className="text-xs text-gray-500 mt-0.5">Indoor Sports Hub</p>
              </div>
            </Link>
              ...
              >
                <form onSubmit={handleSearch}>
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 rounded-full border-2 border-gray-200 focus:border-primary-500 focus:ring-4 focus:ring-primary-100 transition-all duration-200 outline-none text-sm"
                  />
                  <svg
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <>
            ...
            />
            <motion.div
              className="fixed top-[72px] right-0 bottom-0 w-80 bg-white shadow-2xl z-40 lg:hidden overflow-y-auto"
              initial={{ x: '100%' }}
              animate={{ x: 0 }}
              exit={{ x: '100%' }}
